...
const galleryImages: GalleryImage[] = [
  {
    id: 1,
    src: 'https://res.cloudinary.com/dmhu32ya9/image/upload/w_600,h_800,c_fill/v1777798803/ethio-hub/avatars/festivalandproductimage/fzfj0bverugasrobafk0.webp',
    alt: 'Traditional Ethiopian coffee ceremony',
    altAm: 'ባህላዊ የኢትዮጵያ ቡና ስነስርዓት',
    category: 'Coffee Ceremony',
    categoryAm: 'የቡና ስነስርዓት',
  },
  {
    id: 2,
    src: 'https://res.cloudinary.com/dmhu32ya9/image/upload/w_600,h_400,c_fill/v1777798809/ethio-hub/avatars/festivalandproductimage/qdrfjcmefptoteutrlen.avif',
    alt: 'Colorful Timket festival celebration',
  ...
  {
    id: 3,
    src: 'https://res.cloudinary.com/dmhu32ya9/image/upload/w_600,h_600,c_fill/v1777798811/ethio-hub/avatars/festivalandproductimage/q9lycufuumoflweo7cyy.webp',
    alt: 'Artisan weaving traditional basket',
    altAm: 'የጥበብ ባለሙያ ባስኬት በማስጥ',
    category: 'Artisan Work',
    categoryAm: 'የጥበብ ሥራ',
  },
  {
    id: 4,
    src: 'https://res.cloudinary.com/dmhu32ya9/image/upload/w_600,h_800,c_fill/v1777798814/ethio-hub/avatars/festivalandproductimage/kpwld69hcxz4djeskl7r.webp',
    alt: 'Traditional Ethiopian food platter',
    altAm: 'ባህላዊ የኢትዮጵያ ምግብ ሰሌዳ',
    category: 'Ethiopian Food',
    categoryAm: 'የኢትዮጵያ ምግብ',
  },
  {
    id: 5,
    src: 'https://res.cloudinary.com/dmhu32ya9/image/upload/w_600,h_400,c_fill/v1777798817/ethio-hub/avatars/festivalandproductimage/keu3yplue7d67f4zkb2x.webp',
    alt: 'Lalibela rock-hewn churches',
    altAm: 'ላሊበላ ከተማ ድንጋይ የተሰሩ ቤተክርስቲያኖች',
    category: 'Heritage Site',
    categoryAm: 'የቅርስ ቦታ',
  },
  {
    id: 6,
    src: 'https://res.cloudinary.com/dmhu32ya9/image/upload/w_600,h_600,c_fill/v1777798818/ethio-hub/avatars/festivalandproductimage/uxp6xscbdioiancfgrng.webp',
    alt: 'Handcrafted Ethiopian jewelry',
    altAm: 'የእጅ የተሰራ የኢትዮጵያ ጌጥ',
    category: 'Jewelry',
    categoryAm: 'ጌጥ',
  },
  {
    ...
    alt: 'Gondar Fasilides Castle',
    altAm: 'ጎንድር ፋሲሊዴስ አደጋ',
    category: 'Historical Site',
    categoryAm: 'ታሪካዊ ቦታ',
  },
  {
    id: 8,
    src: 'https://images.unsplash.com/photo-1572252009286-268acec5ca0a8?w=600&h=800&fit=crop',
    alt: 'Traditional Ethiopian dance performance',
    altAm: 'ባህላዊ የኢትዮጵያ الرقصة',
    category: 'Cultural Dance',
    categoryAm: 'ባህላዊ እንቁስስ',
  },
  {
    id: 9,
    src: 'https://images.unsplash.com/photo-1562962280-749b6e76a9d2?w=600&h=400&fit=crop',
    alt: 'Traditional Habesha Kemis clothing',
    altAm: 'ባህላዊ የኢትዮጵያ ክሚስ',
