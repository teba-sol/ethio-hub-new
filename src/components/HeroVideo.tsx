    ...
    <section className="relative min-h-[95vh] flex items-center overflow-hidden bg-ethio-dark">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-20 md:pt-28 lg:pt-32 pb-12">
        <div className={`max-w-4xl transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
          ...
          <div className="mt-14 flex flex-wrap items-center gap-6 lg:gap-10">
            <div className="flex items-center gap-3">
              <div className="flex -space-x-4">
                {[1, 2, 3, 4].map(i => (
                  <div 
                    key={i} 
                    className="w-12 h-12 rounded-full ring-2 ring-ethio-dark overflow-hidden bg-gradient-to-br from-primary to-secondary"
                  >
                    <img 
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-sm font-medium tracking-wide text-white/90">
                <span className="text-secondary font-bold text-lg">4.9</span>
                <span className="text-white/60 text-xs"> /5</span>
                <span className="text-white/70 ml-2">from 2,000+ happy travelers</span>
              </p>
            </div>
          </div>
        </div>
