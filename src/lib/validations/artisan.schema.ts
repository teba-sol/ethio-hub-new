...
export const ArtisanProductSchema = z.object({
  ...
  description_en: z.string().min(3, "English description must be at least 3 characters"),
  description_am: z.string().min(3, "Amharic description must be at least 3 characters"),
