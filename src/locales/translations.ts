...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    dashboard: {
      ...
      manageCelebrations: "Manage your cultural celebrations.",
      viewBookings: "View Bookings",
      checkReviews: "Check Reviews",
      analyticsSnapshot: "Analytics Snapshot",
      activeListings: "Active Listings",
      totalCapacity: "Total Capacity",
      recentEventBookings: "Recent Event Bookings",
      upcomingTimeline: "Upcoming Timeline",
      sevenDayBookingTrend: "7-Day Booking Trend",
      realTimeData: "Real-time Data",
      topVisitorLocations: "Top Visitor Locations",
      mostBookedEvent: "Most Booked Event",
      touristsBooked: "{count} tourists booked this event",
      yourActiveEvents: "Your Active Events",
      noUpcomingEvents: "No upcoming events. Create your first festival!",
      noBookingData: "No booking data yet",
      noLocationData: "No location data available yet.",
      launchNewListing: "Launch New Listing",
      missionControl: "Mission Control",
      needHelp: "Need Help?",
      organizerGuideTips: "Check our organizer guide for tips on maximizing your event success.",
      contactSupport: "Contact Support",
      organizerTips: "Organizer Tips",
  ...
  home: {
    ...
    timelessAttractionsHeadline: "Living Heritage & Sacred Landscapes",
    timelessAttractionsDesc: "Experience Ethiopia's rich cultural tapestry through sacred festivals and legendary sites that have captivated travelers for centuries.",
    ...
    discoverHeart: "Discover the Heart of",
      ...
      heritageSpotlightTitle: "Heritage Spotlight",
      heritageSpotlightHeadline: "Discover the Soul of Ethiopia",
      heritageSpotlightDesc: "Ethiopia is a land of vibrant traditions and ancient history. Explore the four pillars of our cultural identity through this curated media experience.",
      cultureDescriptions: {
        meskel: "The finding of the True Cross is marked by the Demera bonfire, where thousands gather in yellow daisies and white traditional clothes.",
        timkat: "The Epiphany celebration is a UNESCO intangible heritage, featuring the Tabot procession and spiritual immersion in water.",
        lalibela: "11 monolithic churches carved out of single pieces of rock in the 12th century, still active centers of worship today.",
        irreecha: "The Oromo people celebrate Irreecha at Lake Tuppo and Addis Ababa, expressing gratitude for the arrival of spring and harvest."
      },
      liveHappening: "Live / Happening Now",
      upcomingEvents: "Upcoming Events",
      whyChooseUs: "WHY CHOOSE US",
      whyChooseUsHeadline: "Your Gateway to Authentic Ethiopian Culture",
      whyChooseUsDesc: "We bridge the gap between global travelers and Ethiopia's rich cultural heritage, ensuring safe, authentic, and unforgettable experiences.",
  ...
  dashboard: {
    ...
    helpCenter: "የእርዳታ ማዕከል",
      approved: "ጸድቋል",
      suspended: "ታግዷል",
      accountSuspended: "መለያ ታግዷል - ይዘትዎ ከሌሎች ተጠቃሚዎች ተደብቋል",
      createDisabledForSuspended: "መለያዎ በታገደበት ጊዜ መፍጠር አይቻልም።",
      welcomeName: "እንኳን ደህና መጡ፣ {name}",
      manageCelebrations: "ባህላዊ በዓላትዎን ያስዳድሩ።",
      viewBookings: "ቦታ ማስያዣዎችን ይመልከቱ",
      checkReviews: "ግምገማዎችን ይመልከቱ",
      analyticsSnapshot: "የትንታኔ ማጠቃለያ",
      activeListings: "ንቁ ዝርዝሮች",
      totalCapacity: "ጠቅላላ አቅም",
      recentEventBookings: "የቅርብ ጊዜ የዝግጅት ቦታ ማስያዣዎች",
      upcomingTimeline: "የሚመጡ ዝግጅቶች የጊዜ ሰሌዳ",
      sevenDayBookingTrend: "የ7-ቀን ቦታ ማስያዣ አዝማሚያ",
      realTimeData: "የቀጥታ መረጃ",
      topVisitorLocations: "ከፍተኛ የጎብኝዎች ቦታዎች",
      mostBookedEvent: "በብዛት የተያዘ ዝግጅት",
      touristsBooked: "{count} ቱሪስቶች ይህንን ዝግጅት ይዘዋል",
      yourActiveEvents: "የእርስዎ ንቁ ዝግጅቶች",
      noUpcomingEvents: "ምንም የሚመጡ ዝግጅቶች የሉም። የመጀመሪያውን በዓል ይፍጠሩ!",
      noBookingData: "እስካሁን ምንም የቦታ ማስያዝ መረጃ የለም",
      noLocationData: "እስካሁን ምንም የአካባቢ መረጃ የለም።",
      launchNewListing: "አዲስ ዝርዝር ይጀምሩ",
      missionControl: "ዋና መቆጣጠሪያ",
      needHelp: "እርዳታ ይፈልጋሉ?",
      organizerGuideTips: "የዝግጅትዎን ስኬት ለማሳደግ የአዘጋጅ መመሪያችንን ይመልከቱ።",
      contactSupport: "ድጋፍ ያግኙ",
      organizerTips: "የአዘጋጅ ምክሮች",
      latestAlerts: "የቅርብ ጊዜ ማንቂያዎች",
    },
  ...
  settings: {
    ...
    addExtraLayer: "ተጨማሪ የደህንነት ደረጃ ይጨምሩ",
    enable: "አንቃ",
    profile: "መገለጫ",
    uploadPhoto: "ፎቶ ስቀል",
    preferences: "ምርጫዎች",
  ...
  home: {
    ...
    timelessAttractionsHeadline: "ህያው ቅርስ እና የተቀደሱ መልክዓ ምድሮች",
    timelessAttractionsDesc: "ለብዙ ዘመናት ተጓዦችን በሳቡ የተቀደሱ በዓላትና ታዋቂ ስፍራዎች የኢትዮጵያን የበለጸገ የባህል ታሪክ ይለማመዱ።",
    ...
    heritageSpotlightTitle: "የቅርስ ትኩረት",
    heritageSpotlightHeadline: "የኢትዮጵያን ነፍስ ያግኙ",
    heritageSpotlightDesc: "ኢትዮጵያ የደመቁ ወጎች እና የጥንታዊ ታሪክ ምድር ናት። በዚህ በተመረጠ የሚዲያ ተሞክሮ የባህላዊ ማንነታችንን አራት ምሰሶዎች ያስሱ።",
    cultureDescriptions: {
      meskel: "የመስቀል በዓል በደመራ እሳት ይከበራል፣ በሺዎች የሚቆጠሩ ሰዎች በቢጫ አደይ አበባ እና በነጭ ባህላዊ ልብሶች ይሳተፋሉ።",
      timkat: "የጥምቀት በዓል የዩኔስኮ የማይዳሰስ ቅርስ ነው፣ የታቦት ሰልፍ እና በመንፈሳዊ ውሃ ውስጥ መጥለቅን ያካትታል።",
      lalibela: "በ12ኛው ክፍለ ዘመን ከአንድ ድንጋይ ተፈልፍለው የተሰሩ 11 አብያተ ክርስቲያናት፣ ዛሬም ድረስ ንቁ የአምልኮ ማዕከላት ናቸው።",
      irreecha: "የኦሮሞ ሕዝብ በሆራ ፊንፊኔ እና በቢሾፍቱ ሆራ አርሰዲ ኢሬቻን ያከብራል፣ ለጸደይ እና ለመከር መምጣት ምስጋና ያቀርባል።"
    },
    liveHappening: "የቀጥታ / በሂደት ላይ",
    upcomingEvents: "መጪ ዝግጅቶች",
    whyChooseUs: "ለምን እኛን ይመርጣሉ",
    whyChooseUsHeadline: "ወደ ትክክለኛው የኢትዮጵያ ባህል መግቢያዎ",
    whyChooseUsDesc: "ደህንነቱ የተጠበቀ፣ እውነተኛ እና የማይረሱ ተሞክሮዎችን በማረጋገጥ በአለም አቀፍ ተጓዦች እና በኢትዮጵያ የበለጸገ የባህል ቅርስ መካከል ያለውን ልዩነት እናጠበባለን።",
 ...
 festival: {
  ...
  types: {
    religious: "ሃይማኖታዊ",
    culturaltraditional: "ባህላዊ",
    nationalpublicholidays: "ብሔራዊ በዓል",
    historical: "ታሪካዊ",
    harvest: "መከር",
    newyear: "አዲስ ዓመት"
  },
